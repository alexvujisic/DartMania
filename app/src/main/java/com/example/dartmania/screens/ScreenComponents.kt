...
import com.example.dartmania.ui.theme.Green
...
fun WinWith9DartsAnimation(
    ...
    LaunchedEffect(isVisible) {
        if (isVisible) {
            delay(5000) // Show animation for 5 seconds
            visible = false
            onAnimationEnd()
        }
    }
    ...
    AnimatedVisibility(
        ...
        Box(
            ...
            Card(
                ...
                Text(
                    text = "Congratulations! " + player + " won with 9 darts!",
                    color = Color.White,
                    fontSize = 24.sp,
